...
class AdamOptimizer:
    def __init__(self, similarity_matrix, gamma, update_sim_matr, objective_function, gradient_function, num_iterations=100, lambda_v=.99, lambda_s=.9999, epsilon=1e10-8, alpha=10):
        '''
